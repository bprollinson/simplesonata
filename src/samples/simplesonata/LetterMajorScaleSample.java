...
public class LetterMajorScaleSample implements Sample
{
    ...
    {
        NoteSequence noteSequence = new NoteSequence(new Note("C", 5, 1), new Note("D", 5, 0.5), new Note("E", 5, 0.5), new Note("F", 5, 0.5), new Note("G", 5, 0.5), new Note("A", 5, 0.5), new Note("B", 5, 0.5), new Note("C", 6, 1));
